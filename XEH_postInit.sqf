private _action = [
    ...
    {
        (_target isKindOf "WeaponHolderSimulated" || _target isKindOf "WeaponHolder" || !alive _target || typeOf _target == "Box_T_East_Wps_F") &&
...
["Box_T_East_Wps_F", 0, ["ACE_MainActions"], _action, true] call ace_interact_menu_fnc_addActionToClass;